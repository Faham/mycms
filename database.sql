...
CREATE TABLE IF NOT EXISTS `hci_settings` (
...
CREATE TABLE IF NOT EXISTS `hci_research` (
...
CREATE TABLE IF NOT EXISTS `hci_publication` (
...
CREATE TABLE IF NOT EXISTS `hci_people` (
...
CREATE TABLE IF NOT EXISTS `hci_people_publication` (
  `people_id` int(11) NOT NULL,
  `publication_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_publication_people` AS (SELECT * FROM `hci_people_publication`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_people_research` (
  `people_id` int(11) NOT NULL,
  `research_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_research_people` AS (SELECT * FROM `hci_people_research`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_publication_research` (
  `publication_id` int(11) NOT NULL,
  `research_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_research_publication` AS (SELECT * FROM `hci_publication_research`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_image` (
...
CREATE TABLE IF NOT EXISTS `hci_video` (
...
CREATE TABLE IF NOT EXISTS `hci_doc` (
...
CREATE TABLE IF NOT EXISTS `hci_image_people` (
  `image_id` int(11) NOT NULL,
  `people_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_people_image` AS (SELECT * FROM `hci_image_people`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_image_publication` (
  `image_id` int(11) NOT NULL,
  `publication_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_publication_image` AS (SELECT * FROM `hci_image_publication`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_image_research` (
  `image_id` int(11) NOT NULL,
  `research_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_research_image` AS (SELECT * FROM `hci_image_research`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_video_publication` (
  `video_id` int(11) NOT NULL,
  `publication_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_publication_video` AS (SELECT * FROM `hci_video_publication`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_video_research` (
  `video_id` int(11) NOT NULL,
  `research_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_research_video` AS (SELECT * FROM `hci_video_research`);

-- ----------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS `hci_doc_publication` (
  `doc_id` int(11) NOT NULL,
  `publication_id` int(11) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ;

CREATE OR REPLACE VIEW `hci_publication_doc` AS (SELECT * FROM `hci_doc_publication`);
